...
CZTSideBar.Shape BRIK 0.3 2.0 0.3
...
CZTSideSegment.Shape BRIK 19.5 2.25 0.4
// NEEDS THIS LINE TO VIEW ALONE:
//CZTSideSegment.Mother 0

// Put the CZT bars into the segment
For I 48 -19.1 0.8125
    CZTSideBar.Copy CZTSideBar_%I
    CZTSideBar_%I.Position $I 0.0 0.0
    CZTSideBar_%I.Mother PassiveCZTSideFrame_Block
Done
