...
// Single finger is 0.5cm x 0.5cm x 6.0
Volume CSIFinger
CSIFinger.Material CsI
CSIFinger.Visibility 1
CSIFinger.Color 2
CSIFinger.Shape BOX 0.25 0.25 3.0

//Build Single Segment (Tray): 64 fingers (8 x 8) is 4 x 4 x 6 cm
Volume CSIFingerSegment
CSIFingerSegment.Material Vacuum
CSIFingerSegment.Visibility 0
CSIFingerSegment.Shape BOX 2. 2. 3.0
